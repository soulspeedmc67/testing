...
const buttonVariants = {
  default: "bg-[#0c831f] text-white hover:bg-emerald-800 shadow-sm active:scale-[0.97]",
  ...
  subtleEmerald: "bg-emerald-50 text-[#0c831f] border border-emerald-200/80 hover:bg-emerald-100 active:scale-[0.97]",
