...
const badgeVariants = {
  ...
  secondary: "bg-slate-100 text-slate-800 dark:bg-surface-muted dark:text-content",
  ...
  outline: "text-slate-800 border border-slate-200 dark:text-content dark:border-line"
};
