      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-8 py-10 sm:py-16">
        <div className="bg-white rounded-3xl p-6 sm:p-12 border border-slate-200/80 shadow-sm space-y-8">
          ...
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">1. Introduction</h2>
          ...
          {/* Section 2 */}
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">2. Information We Collect</h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          {/* Section 3 */}
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">3. How We Use Your Information</h2>
            <ul className="list-disc pl-5 space-y-2 text-xs sm:text-sm text-slate-600">
          ...
          {/* Section 4 */}
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">4. Location Data &amp; Permissions</h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          {/* Section 5 */}
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">5. Account Deletion &amp; Data Rights</h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 text-xs sm:text-sm text-slate-700 space-y-2">
              <p className="font-bold text-[#061838]">How to Delete Your Account:</p>
              <p>
                1. Navigate to <strong>Account Profile</strong> in the DASHIT mobile app and tap <strong>Delete Account</strong>.
              </p>
              <p>
                2. Or use our <a href="/delete-account" className="text-[#FF5B00] underline font-bold">account deletion page</a>, or email <a href="mailto:support@dashit.co.in" className="text-[#FF5B00] underline font-bold">support@dashit.co.in</a> with your registered phone number.
              </p>
              <p>
          ...
          {/* Section 6 */}
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">6. Data Security</h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          {/* Section 7 */}
          <section className="space-y-3">
            <h2 className="text-lg sm:text-xl font-bold text-[#061838]">7. Contact &amp; Grievance Redressal</h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
